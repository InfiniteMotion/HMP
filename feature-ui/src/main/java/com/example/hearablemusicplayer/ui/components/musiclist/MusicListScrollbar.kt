...
/**
 * 垂直滚动条：轨道 + 拇指，与 [listState] 联动；支持拖动拇指滚动列表。
 */
@Composable
internal fun MusicListScrollbar(
    ...
    val trackColor = config.trackColor ?: androidx.compose.ui.graphics.Color.Black.copy(alpha = 0.1f)
    val thumbColor = config.thumbColor ?: androidx.compose.ui.graphics.Color.Black.copy(alpha = 0.4f)
    ...
    Box(
        ...
        Canvas(
            ...
            drawRoundRect(
                ...
                size = Size(w, thumbH),
                cornerRadius = androidx.compose.ui.geometry.CornerRadius(thumbCornerPx),
            )
        }
    }
}
