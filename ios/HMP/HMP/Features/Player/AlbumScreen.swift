...
/// 专辑详情页 — 对应 Android AlbumScreen.kt
struct AlbumScreen: View {
    ...
    var body: some View {
        SubScreen(title: albumName) {
            switch viewModel.selectedAlbumMusicState {
            case .idle, .loading:
                ProgressView()
        ...
        .onAppear { viewModel.loadAlbumMusicList(albumName: albumName) }
    }
