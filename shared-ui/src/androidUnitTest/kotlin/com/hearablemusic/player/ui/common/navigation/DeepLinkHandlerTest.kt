...
class DeepLinkHandlerTest {
    ...
    fun `fromJson should parse valid song deep link JSON`() {
        // Given
        val json = """{"type":"com.hearablemusic.player.ui.common.navigation.DeepLink.Song","musicId":123}"""
    ...
    fun `fromJson should parse valid playlist deep link JSON`() {
        // Given
        val json = """{"type":"com.hearablemusic.player.ui.common.navigation.DeepLink.Playlist","name":"favorites"}"""
