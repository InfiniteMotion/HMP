...
class PlaylistRepositoryImpl(
    ...
    override fun getMusicInfoInPlaylist(playlistId: Long): Flow<List<MusicInfo>> = MutableStateFlow(emptyList())
    override fun getAllPlaylistsFlow(): Flow<List<Playlist>> = MutableStateFlow(emptyList())
    ...
    override suspend fun exportPlaylistsSnapshot(): com.hmp.domain.backup.PlaylistsSnapshot =
        com.hmp.domain.backup.PlaylistsSnapshot(emptyList(), emptyList())
